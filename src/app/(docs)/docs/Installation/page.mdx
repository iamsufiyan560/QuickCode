...
Browse the [QuickCode GitHub components folder](https://github.com/iamsufiyan560/QuickCode/tree/main/src/components/ui), copy the component you need, and paste it into your project at:
